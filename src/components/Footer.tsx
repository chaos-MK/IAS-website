...
const Footer: React.FC = () => {
    return (
      <footer className="bg-gradient-to-br from-white-500 to-gray-10 pt-16 pb-8">
          ...
          <div className="text-center mb-12">
            ...
            <div className="flex justify-center space-x-8 mb-8">
              <a 
                ...
                className="group bg-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
              ...
              <a 
                ...
                className="group bg-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
              >
                <svg className="w-6 h-6 text-blue-700 group-hover:text-blue-800 transition-colors" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className='bg-gradient-to-br from-gray-10 to-gray-100'>
